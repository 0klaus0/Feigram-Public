...
function envDefaults() {
  ...
  return {
    ...
    telegramTransport: process.env.TELEGRAM_TRANSPORT || "abridged",
...
function sanitize(input = {}) {
  ...
  return {
    ...
    telegramProxyUsername: String(input.telegramProxyUsername ?? "").trim(),
    telegramProxyPassword: String(input.telegramProxyPassword ?? ""),
    telegramTransport: ["abridged", "obfuscated"].includes(input.telegramTransport) ? input.telegramTransport : "abridged",
...
function publicSettings(settings) {
  return {
    ...
    telegramProxyUsername: settings.telegramProxyUsername,
    telegramProxyPasswordSet: Boolean(settings.telegramProxyPassword),
    telegramTransport: settings.telegramTransport,
